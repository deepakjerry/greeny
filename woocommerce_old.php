<?php get_header(); ?>
   ...
   <!--=====================================
                    BANNER PART START
        =======================================-->
        <section class="inner-section single-banner" style="background: url(<?php echo bloginfo('template_url') ?>/images/single-banner.jpg) no-repeat center;">
            <div class="container">
                <h2>Shop 4 Column</h2>
                <ol class="breadcrumb">
                ...
                <div class="row content-reverse">
                    <div class="col-lg-3">
                        <div class="shop-widget-promo">
                            <a href="#"><img src="<?php echo bloginfo('template_url') ?>/images/promo/shop/01.jpg" alt="promo"></a>
                        </div>
